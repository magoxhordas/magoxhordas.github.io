...
**Damage lag na barra:** a vida vermelha cai na hora e uma faixa clara alcança o
novo valor em 320 ms, mostrando quanto acabou de entrar. Lê a mesma
porcentagem — não escreve vida nenhuma.
...
`node scripts/verify-combat-juice.mjs` — **98 checagens**, quase todas simulando
