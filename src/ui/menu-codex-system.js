...
function renderCollBosses(grid){
  const BOSS_DATA=[
    ...
    {id:'hunter_spider',name:'Aranha Caçadora',wave:9,biome:'Floresta',color:'#b98bd8',hp:2400,dmg:15.5,art:'assets/enemies/spider2/codex.png',
      ...
      statsNote:'Vida base: varia com a dificuldade e o cooperativo. Mordida: até 15,5 (limite de 13% da vida máxima do herói); fase: até 24 e investida: até 22 (ambas limitadas a 18%). As teias não acumulam lentidão e somem ao derrotar a Caçadora.'},
