...
petSystem.atualizarPet(.016);
assert(petState.pet.x===538&&petState.pet.y===508&&!petState.pet.andando,
...
assert(!farmDrawCalls.some(([,x,y,w,h])=>Number(w)*Number(h)>16),
  'parcela regada voltou a receber uma caixa grande durante o desenho das plantas');
sandbox.farmCells[0].state='plowed';sandbox.farmCells[0].seed=null;
