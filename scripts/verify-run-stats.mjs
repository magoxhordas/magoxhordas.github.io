...
stats.recordCombo({playerIndex:0,value:42});stats.recordCombo({playerIndex:0,value:41});
assert(stats.getSnapshot().team.maxCombo===42,'recorde de combo regrediu ou nao foi agregado');
...
assert(result.team.maxCombo===42,'maior combo nao chegou ao resumo final');
