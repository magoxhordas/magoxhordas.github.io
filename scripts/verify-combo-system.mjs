...
// ═══════════════════════════════════════════════════════
{
  ...
  exigir(C.notificarAbate(p,{maxHp:30},'summon')===0,'abate de summon nao pode aumentar o combo');
  exigir(C.notificarAbate(p,{maxHp:30},'blessing')===0,'abate de bencao nao pode aumentar o combo');
...
// ═══════════════════════════════════════════════════════
{
  ...
  exigir(campanha.includes('ComboSystem.bonusRecompensa'),
    'a recompensa de onda precisa aplicar o bonus de combo');
}
