...
function renderCollBosses(grid){
  const BOSS_DATA=[
    {id:'brute',name:'Brutamontes da Guerra',wave:4,biome:'Castelo',color:'#4a7a28',hp:2400,dmg:20.4,art:'assets/bosses/orc/icon.png',
    ...
    {id:'skeleton_king',name:'Rei Cadáver',wave:5,biome:'Castelo',color:'#ece4cc',hp:3000,dmg:43,art:'assets/bosses/skelking/icon.png',
    ...
    {id:'hunter_spider',name:'Aranha Caçadora',wave:9,biome:'Floresta',color:'#b98bd8',hp:2400,dmg:30,art:'assets/enemies/spider2/codex.png',
      ...
      powers:[['Mordida da caçadora','Persegue o herói e ataca quando alcança sua presa.'],['Investida da Caçadora','Marca uma direção por 0,8 segundo e avança em linha reta, sem corrigir a trajetória. Acerta cada herói uma única vez e depois fica parada por 1 segundo para se recuperar.'],['Armadilhas de Seda','Tece até três armadilhas no chão, com aviso antes de ativar. Duram 6 segundos e reduzem a velocidade em 30% enquanto o herói pisa nelas, sem causar dano nem imobilizar.'],['Fase Parcial','Desaparece por instantes e reaparece perto do alvo para atacar e desacelerar.'],['Vínculo com Aracne','Derrotá-la aumenta em 6% o tempo de recarga dos ataques de Aracne no capítulo.']],
      statsNote:'Vida base: varia com a dificuldade e o cooperativo. Dano antes das defesas do herói: mordida até 30 (limite de 22% da vida máxima), Fase Parcial até 40 (28%) e investida até 48 (32%). As teias não acumulam lentidão e somem ao derrotar a Caçadora.'},
    {id:'aracne',name:'Aracne Ancestral',wave:10,biome:'Floresta',color:'#aa66dd',hp:3600,dmg:60,art:'assets/bosses/aracne/icon.png',
