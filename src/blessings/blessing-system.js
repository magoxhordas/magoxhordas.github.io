...
// pl.baseCrit e' o critico INATO da classe (o Arqueiro tem 25%). Este
// applyCardCrit SUBSTITUI o do index.html — quem nao somar aqui nao
// aparece no jogo, por mais que a versao de la' esteja certa.
let chance=(pl.baseCrit||0)+(e.critChance||0)+(e.morosPity||0);try{if(typeof getCampaignShopCritBonus==='function')chance+=getCampaignShopCritBonus(pl);}catch(_){}
