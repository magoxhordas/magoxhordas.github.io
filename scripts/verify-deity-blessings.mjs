...
assert.equal(typeof context.applyDeityBoon,'function','O motor deve publicar applyDeityBoon sem depender de uma declaração global antiga.');
assert.equal(typeof context.notifyBlessingAttack,'function','O motor deve publicar notifyBlessingAttack sem depender de outro módulo.');
